                  ...
                  Padding(
                      ...
                      child: Material(
                          ...
                          child: InkWell(
                            borderRadius: BorderRadius.circular(50),
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => SearchFriendWidget()));
                            },
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                child: Text("No"),
                                                style: ElevatedButton.styleFrom(primary: Colors.green.withOpacity(0.8))),
                                          ),
                                        ),
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: ElevatedButton(
                                                ...
                                                child: Text("Yes"),
                                                style: ElevatedButton.styleFrom(primary: Colors.red.withOpacity(0.8))),
                                          ),
                                        ),
                                      ],
                                    )
              ...
              if (snapshot.hasData) {
                if (snapshot.data!.size != 0) {
                  ...
                  for (var message in messages) {
                    ...
                    if ((((messageWidget["getSender"] == user['id']) || (messageWidget["getDestination"] == user['id'])))) {
                        ...
                        child: InkWell(
                          child: Padding(
                            ...
                            child: user['id'] == msg[index]["getSender"]
                                ? Row(
                                    children: [
                                      CircleAvatar(radius: 33, backgroundImage: NetworkImage("${user["avatar"]}")),
                                      Expanded(
                                        child: Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Column(
                                ...
                                : StreamBuilder<QuerySnapshot>(
                                    stream: FirebaseFirestore.instance
                                        .collection("users")
                                        .where('id', isEqualTo: msg[index]["getSender"])
                                        .snapshots(),
                                      ...
                                      if (snapshot.hasData) {
                                        return Row(
                                          children: [
                                            CircleAvatar(
                                                radius: 33,
                                                backgroundImage: NetworkImage("${snapshot.data!.docs[0].get('avatar')}")),
                                            Expanded(
                                              child: Padding(
                                                padding: const EdgeInsets.all(8.0),
                                                child: Column(
...
/*    onTap: () async {
                                    var destination = await FirebaseFirestore.instance
                                        ...
                                        .where(
                                          "id",
                                          isEqualTo: this.user['id'] == msg[index]["getDestination"]
                                              ? "${msg[index]["getSender"]}"
                                              : "${msg[index]["getDestination"]}",
                                        )
                                        .get();
                                    var user = User.fromJson(destination.docs.toList().first.data() as Map<String, dynamic>);
/*
                                    Get.to(Messenger(
                                      user: user,
                                    ));*/
